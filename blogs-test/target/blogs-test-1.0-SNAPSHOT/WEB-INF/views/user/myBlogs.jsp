        ...
        <div class="col-md-8">
            ...
            <ul class="list-group" >
                <a href="#" style="color:black">
                    <h2 class="list-group-item" style="background: floralwhite"> 文章标题 </h2></a>
                ...
                <div id="content1" >
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <p>昵称:${create_info.nickname}
                            <p>粉丝:${create_info.fans}
                            <p>关注:${create_info.favourite}
                            <p>园龄:${create_info.registerTime}
                            <p>邮箱:${create_info.email}
                        </div>
