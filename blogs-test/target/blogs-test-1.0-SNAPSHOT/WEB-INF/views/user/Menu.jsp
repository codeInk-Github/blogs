    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/user/${username}" >我的文章 </a></li>
        ...
        <div id="side_nav" class="side-left tab-bar" style="background: white">
            ...
            <div class="col-xs-1" >
                <ul class="nav nav-pills nav-stacked" >
                    ...
                    <li class="draft"><a href="${pageContext.request.contextPath}/drafts">  <img src="${pageContext.request.contextPath}/static/css/images/draft.png"  height="20" />草稿箱</a></li>
