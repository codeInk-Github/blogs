...
<body>
<div class="adminLogin admin_login">
    <div id="formContent">
        <!-- Tabs Titles -->
        ...
        <form id="adminLogin_form" action="${pageContext.request.contextPath}/admin/login">
            <input type="text" id="login" class="fadeIn second" name="adminName" placeholder="请输入账号">
            <input type="password" id="password" class="fadeIn third" name="adminPassword" placeholder="请输入密码">
            <input type="submit" id="adminLogin_btn" class="fadeIn fourth" value="Log In">
        </form>
...
<script type="text/javascript">
        $("input[name]").focusout(function(e){
            ...
            }else if($(this).attr('name')==='adminPassword'){
                $(this).attr("class","invalid");
            }
        });
    $(function (){
        $("#adminLogin_btn").click(function (){
            if(document.getElementById("adminName").value.length<3 || document.getElementById("adminPassword").value.length>16){
                alert("用户名长度必须介于2-16个字符之间！");
            }else{
